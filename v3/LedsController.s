...
LEDCONTROLLER:
  ...
  beq r13, r0, SKIPSOMA    # if(r13 != 0)
  addi r13, r13, 9         # r13 = 10
  SKIPSOMA: 
  ldwio r14, 12(r12)       # r14 = INPUT_BUFFER[3]
  subi r14, r14, 0x30      # r14 = convert ASCIInumber to int
  add r14, r13, r14        
  ldwio r13, 4(r12)        # r13 = INPUT_BUFFER[1]
  movia r9, 0x30           # r9 = ASCII '0'
  bne r13, r9, ELSEIF      # if(r13 = r9)
  movia r16, 0x1           # r16 = Mask(1)
  sll r14, r16, r14        # shift left r16 r14 times
  or r14, r14, r17         # turn on r14 and keep the leds that were already on
  stwio r14, (r15)         # Print RED_LED
  ELSEIF:
  movia r9, 0x31           # r9 = ASCII '1'
  bne r13, r9, ENDLED      # if(r13 = r9)
  addi r16, r0, -2         # r16 = Mask(0xfffffffe)
  rol r14, r16, r14        # roll left r16 r14 times
  and r14, r14, r17        # turn off r14 and keep the others leds that were already on
  stwio r14, (r15)         # Print RED_LED
ENDLED:
